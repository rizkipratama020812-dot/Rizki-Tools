...
const TOOLS_CONFIG = [
    {
        ...
        endpoint: (data) => `${BASE_DOMAIN}/maker/brat?text=${formatParam(data.text)}&apikey=${API_KEY}`,
        type: 'image'
    },
    {
        id: 'bratvid',
    ...
    },
    {
        ...
        endpoint: (data) => `${BASE_DOMAIN}/tools/blurface?url=${encodeURIComponent(data.url)}&apikey=${API_KEY}`,
        type: 'image'
    },
    {
        id: 'fakeml',
